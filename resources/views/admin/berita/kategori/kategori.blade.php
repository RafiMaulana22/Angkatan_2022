                                ...
                                <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel"
                                    ...
                                    <div
                                        ...
                                        <button
                                            ...
                                            <a href="/kategori_berita/tambah"
                                                class="btn text-white text-bordered py-sm-1 d-block">
                                                ...
                                                <tbody>
                                                    @foreach ($kategori_berita as $key => $value)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="fw-semibold"><b>{{ $value->nama_kategori }}</b></span>
                                                                <br>
                                                                <small><span>Created at :
                                                                        {{ $value->created_at }}</span></small>
                                                            </td>
                                                            <td>
